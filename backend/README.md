...
## Project Structure
    ...
    ├── philips_display_dat_35821  # Django project configurations
...
1. Clone this repo and `cd philips_display_dat_35821`
...
2. Clone this repo and `cd philips_display_dat_35821`
